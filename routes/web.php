...
Route::middleware(['auth', 'verified'])->group(function () {
    // Subscription Routes (Accessible even if expired)
    ...
    // SuperAdmin Routes (Outside check.subscription)
    ...
    // Profile routes (Keep accessible or protect? Let's protect them too to force subscription update)
    // Actually, user might want to access profile to check details. Let's keep them OUTSIDE check.subscription
